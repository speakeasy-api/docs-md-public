...
export type ResponseExamplesTabbedSectionProps = {
  /**
   * The children of the tabbed section. This will always be an array of
   * `ResponseExamplesTab` components, so we don't use the typical PropsWithChildren`.
   */
  children: React.ReactElement<ResponseExamplesTabProps>[];
...
export type ResponseExamplesTabProps = PropsWithChildren<{
  /**
